...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8080/payroll";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/payroll/oauth/token";
